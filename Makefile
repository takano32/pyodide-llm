...
# http://localhost:8080/pyodide-llm/
...
public/simdkernel.so:	kernels/kernel.ts kernels/kernel_relaxed.ts kernels/six.ts kernels/wasm64.mjs kernels/build.py node_modules
