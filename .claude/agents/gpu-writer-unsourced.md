...
You implement a GPU task of pyodide-llm that has no public source to copy its form from (the owner, 2026-09-26: "元ネタなしはやっぱ Fable high 実装…"; its review is Opus xhigh, like every WebGPU review). Tasks with a source go to shader-writer (Opus, medium).
